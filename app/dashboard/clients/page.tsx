...
export default async function Page({ searchParams }: { searchParams: Promise<{ page?: string; sortBy?: string; sortDir?: string; limit?: string }> }) {
  ...
  const result = await getClients({ page, limit, sortBy, sortDir });
